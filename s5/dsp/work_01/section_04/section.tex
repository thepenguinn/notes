...
\emph{mixing} and \emph{generating} the \textsc{DTFT} for two given \emph{frequences}\footnote{one
...
Let's take a bunch of \textsc{DTFT}s with different \emph{sampling frequences}.
