...
\begin{minted}[breaklines] {python}
    ...
    # plt.imsave("../plots/dftMatrixSixtyFourPointReal.pdf", D.real, dpi = 20)
    # plt.imsave("../plots/dftMatrixSixtyFourPointImaginary.pdf", D.imag, dpi = 20)
\end{minted}
...
\begin{minted}[breaklines] {python}
    ...
    plt.savefig("../plots/moreCircConvComp.pdf", bbox_inches = "tight")
\end{minted}
